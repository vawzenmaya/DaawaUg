...
User user3 = User('Teddy', 'assets/p4.jpg');

final List<Video> videos = [
  Video('v1.mp4', user1, 'This is a clone of Tiktok by Lauren! known to a few as Vawzen. All tiktok rights have be reserved and none  has been violated, putting that aside, Am a Genius Computer Scientist', 'audioName', 50, '3', '4', 8),
