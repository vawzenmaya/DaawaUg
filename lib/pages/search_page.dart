...
class _SearchPageState extends State<SearchPage> {
  ...
  Future<void> fetchData() async {
    try {
      ...
      final channelResponse = await http.get(Uri.parse(ApiConfig.fetchChannelsUrl));

      if (videoResponse.statusCode == 200 && channelResponse.statusCode == 200) {
        setState(() {
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      title: Text(result['title'] ?? result['channelName'] ?? ''),
