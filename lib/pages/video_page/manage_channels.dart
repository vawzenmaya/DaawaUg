...
class ManageApprovedChannels extends StatefulWidget {
  const ManageApprovedChannels({super.key});

  @override
  State<ManageApprovedChannels> createState() => _ManageApprovedChannelsState();
}

class _ManageApprovedChannelsState extends State<ManageApprovedChannels> {
  List<dynamic> users = [];
  ...
  Future<void> fetchUsers() async {
    final response =
        await http.get(Uri.parse(ApiConfig.fetchApprovedChannelsUrl));
